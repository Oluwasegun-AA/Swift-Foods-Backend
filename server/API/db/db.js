...
async function createTables() {
  ...
  const userData = `INSERT INTO user_accounts (user_name,user_role,user_email,user_password)
      ...
      ('shegun', 'Admin', 'oluwasegun.adepoju@andela.com', '${bcrypt.hashSync('password', 10)}'),
      ('shegsteham', 'User', 'oluwasegunadepoju@gmail.com', '${bcrypt.hashSync('password', 10)}'),
      ('usertest', 'User', 'usertest@user.com', '${bcrypt.hashSync('password', 10)}'),
